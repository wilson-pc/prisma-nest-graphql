...
export declare class UserCrudResolver {
    user(ctx: any, args: FindOneUserArgs): Promise<User | undefined>;
    users(ctx: any, args: FindManyUserArgs): Promise<User[]>;
    createUser(ctx: any, args: CreateUserArgs): Promise<User>;
    deleteUser(ctx: any, args: DeleteUserArgs): Promise<User | undefined>;
    updateUser(ctx: any, args: UpdateUserArgs): Promise<User | undefined>;
